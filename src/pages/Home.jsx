...
function Home() {
  return (
    <div className='min-h-[130vh] md:min-h-[100vh] flex flex-col justify-between '>
    <div className=" h-[50vh] md:h-[95vh] bg-[url('assets/images/bg-pattern.svg')] bg-no-repeat bg-cover md:bg-contain">
